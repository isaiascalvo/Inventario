...
namespace Application.Controllers
{
    ...
    public class FeeRuleController : Controller
    {
        ...
        //        IEnumerable<FeeRuleDto> feeRulesDto = await _feeRuleUseCases.GetByFilters(filtersDto);
        //        IEnumerable<FeeRuleViewModel> feeRulesVM = _mapper.Map<IEnumerable<FeeRuleDto>, IEnumerable<FeeRuleViewModel>>(feeRulesDto);
        //        return Ok(feeRulesVM);
        //    }
        //    catch (Exception e)
        ...
        //{
        //    IEnumerable<FeeRuleDto> feeRulesDto = await _feeRuleUseCases.GetByCategory(categoryId);
        //    IEnumerable<FeeRuleViewModel> feeRulesVM = _mapper.Map<IEnumerable<FeeRuleDto>, IEnumerable<FeeRuleViewModel>>(feeRulesDto);
        //    return Ok(feeRulesVM);
        //}
